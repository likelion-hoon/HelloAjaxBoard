...
public class BoardManager {
	...
	static {
		al.add(new Board("111111", "Java수업", "이종훈", "sk", ""));
		al.add(new Board("222222", "Java수업", "이종훈", "sk", ""));		
		al.add(new Board("333333", "Java수업", "이종훈", "sk", ""));		
		al.add(new Board("444444", "Java수업", "이종훈", "sk", ""));		
		al.add(new Board("555555", "Java수업", "이종훈", "sk", ""));		
		al.add(new Board("666666", "Java수업", "이종훈", "sk", ""));		
		al.add(new Board("777777", "Java수업", "이종훈", "sk", ""));		
		al.add(new Board("888888", "Java수업", "이종훈", "sk", ""));		
		al.add(new Board("999999", "Java수업", "이종훈", "sk", ""));		
	}
